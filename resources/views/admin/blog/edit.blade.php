...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="row">
                <form method="post" action="{{route('admin.blog.update', $post->id)}}" enctype="multipart/form-data" id="post-form">
                    {{csrf_field()}}
                    <div class="col-xs-9">
                        <div class="box">
                            <div class="box-body ">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{$post->title}}" id="title" name="title" required="required" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label for="slug">Slug</label>
                                    <input type="text" value="{{$post->slug}}" id="slug" name="slug" required="required" class="form-control">
                                </div>
                                <div class="form-group">
                                    ...
                                    @foreach($categories as $category)
                                        <input type="checkbox" name="category[]" value="{{$category->id}}"
                                            ...
                                            @for ($i=0; $i<$post->categories->count(); $i++)
                                                ...
                                                @if($post->categories[$i]->id == $category->id)
                                                     checked
                                                @endif
                                ...
                                <div class="form-group">
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                            @if($post->img)
                                                <img src="{{asset('storage/media/'.$post->img)}}" alt="...">
                                            @else
                                        ...
                                        <span class="btn btn-default btn-file"><span class="fileinput-new">Change image</span><span class="fileinput-exists">Change</span>
                                            <input type="file" value="{{$post->img}}" name="img"></span>
