                                ...
                                <form action="{{route('admin.user.update' ,$user->id)}}" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="role" id="role">
                                            <option {{$user->roles()->first()->id == 5 ? 'selected' : NULL}} value="5">Admin</option>
                                            <option {{$user->roles()->first()->id == 6 ? 'selected' : NULL}} value="6">Editor</option>
                                            <option {{$user->roles()->first()->id == 7 ? 'selected' : NULL}} value="7">Author</option>
                                        </select>
                                    </div>
