...
@section('content')
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Category
                <small>Edit this category</small>
            </h1>
            <ol class="breadcrumb">
                <li>
                    ...
                    <div class="col-xs-12">
                        <div class="box">
                            <div class="box-body ">
                                ...
                                @endif
                                 <form method="post" action="{{route('admin.category.update', $category->id)}}" id="post-form">
                                 {{csrf_field()}}
                                    ...
                                    <div class="form-group col-xs-4">
                                        ...
                                        <input type="text" value="{{$category->slug}}" id="slug" name="slug" required="required" class="form-control">
                                    </div>
